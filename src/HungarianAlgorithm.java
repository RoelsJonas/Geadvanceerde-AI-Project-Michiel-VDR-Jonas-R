...
/**
 * source: https://github.com/tuliotoffolo/tup/blob/master/tup/src/be/kuleuven/codes/tup/heuristic/assignment/HungarianAlgorithm.java
...
public class HungarianAlgorithm {
    ...
    public static final Map<Integer, Integer> costMemory = new HashMap<>();
    ...
    public static int hungarianAlgo(int[][] matrix) {
        ...
        if (costMemory.containsKey(hash)) {
            return costMemory.get(hash);
        }
    ...
    public static int hungarianAlgo(int round) {
        ...
        for (int currentG=0; currentG<Main.nUmps; currentG++) {
            for (int nextG=0; nextG<Main.nUmps; nextG++) {
                ...
                int startAway = Main.games[round][currentG].away-1;
                int endLocation = Main.games[round+1][nextG].home-1;
                int endAway = Main.games[round+1][nextG].away-1;
    ...
    // ====================================== YES WE LIKE TO COPY ==========================================
    public static int[][] computeAssignments(int[][] matrix) {
    ...
    private static void initStars(int costMatrix[][], int[] starsByRow, int[] starsByCol) {
    ...
    private static boolean addZeroSequence(int total, int[] ints) {
    ...
    private static void makeMoreZeroes(int[][] matrix, int[] coveredRows, int[] coveredCols) {
